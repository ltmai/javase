...
public class RandomWords {
  private static final String INPUT_FILE = "..\\..\\resources\\input\\words.txt";
  private final List<String> sourceWords;

  /**
   * Constructor
   * Task: read all the words (which are one per line) from the source file into a list
   * 
  ...
  public List<String> createList(int listSize) {
    ...
    // YOUR CODE HERE
    wordList = rand.ints(listSize, 0, sourceWords.size()).mapToObj(i->sourceWords.get(i)).collect(Collectors.toList());
    return wordList;
  }
